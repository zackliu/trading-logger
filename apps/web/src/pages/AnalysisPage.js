...
function BreakdownTable({ title, data }) {
    return (_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: title }), _jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Key" }), _jsx("th", { children: "Trades" }), _jsx("th", { children: "Win%" }), _jsx("th", { children: "PF" }), _jsx("th", { children: "Expectancy" })] }) }), _jsx("tbody", { children: data.map((row) => (_jsxs("tr", { style: { borderTop: "1px solid #e6e9f0" }, children: [_jsx("td", { children: row.label }), _jsx("td", { children: row.trades }), _jsx("td", { children: row.winRate ? (row.winRate * 100).toFixed(1) + "%" : "-" }), _jsx("td", { children: row.profitFactor?.toFixed(2) ?? "-" }), _jsx("td", { children: row.expectancy?.toFixed(2) ?? "-" })] }, row.key))) })] })] }));
}
