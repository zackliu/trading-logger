...
export default function RecordDetailPage() {
    ...
    return (_jsxs("div", { className: "card", children: [_jsx("button", { className: "btn secondary", onClick: () => navigate(-1), children: "\u2190 Back" }), _jsx("h2", { style: { marginBottom: "0.25rem" }, children: data.setup?.name ?? "Unknown" }), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.5rem" }, children: [_jsx(Detail, { label: "Symbol", value: data.symbol }), _jsx(Detail, { label: "Setup", value: data.setup?.name ?? "Unknown" }), _jsx(Detail, { label: "Datetime", value: formatDateTime(data.datetime) }), _jsx(Detail, { label: "Account", value: data.accountType }), _jsx(Detail, { label: "Result", value: data.result }), _jsx(Detail, { label: "R Multiple", value: data.rMultiple ?? "-" }), _jsx(Detail, { label: "Complied", value: data.complied ? "Yes" : "No" })] }), _jsxs("div", { style: { marginTop: "0.75rem" }, children: [_jsx("strong", { children: "Tags:" }), " ", data.tags.map((t) => (_jsx("span", { className: "tag", style: { marginRight: "0.3rem" }, children: t.name }, t.id)))] }), data.customValues.length > 0 && (_jsxs("div", { style: { marginTop: "0.75rem" }, children: [_jsx("strong", { children: "Custom Fields" }), _jsx("ul", { children: data.customValues.map((cv) => (_jsxs("li", { children: [_jsxs("strong", { children: [fieldMap.get(cv.fieldId) ?? cv.fieldId, ":"] }), " ", "value" in cv
                                    ? cv.value?.toString()
